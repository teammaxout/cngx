...
_SUCCESS_PATTERNS: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (re.compile(r"\bCI (?:is )?green\b", re.I), "CI green"),
    (re.compile(r"\ball checks passed\b", re.I), "all checks passed"),
    (re.compile(r"\btests are green\b", re.I), "tests are green"),
    (re.compile(r"\b(?:test )?suite is green\b", re.I), "suite is green"),
