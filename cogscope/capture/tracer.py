"""Main tracer for Cogscope - the primary interface for capturing reasoning traces."""
...
from cogscope.core.exceptions import CaptureError
...
class CogscopeTracer:
    ...
    def __init__(
        ...
        config: Optional[CogscopeConfig] = None,
        ...
        **adapter_kwargs: Any,
        ...
        Args:
            ...
            config: Cogscope configuration (defaults to global)
...
def create_tracer(
    ...
    **kwargs: Any,
    ...
    Returns:
        Configured CogscopeTracer instance
    """
    return CogscopeTracer(adapter=adapter, model=model, **kwargs)
