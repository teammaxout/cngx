...
class PipelineResult(BaseModel):
    ...
    # Cogscope gate result (if run with Cogscope)
    ...
    def summarize(self) -> str:
        ...
        if self.cogscope_blocked:
            lines.extend(
                [
                    "",
                    "🛑 Cogscope BLOCKED DEPLOYMENT",
                ]
            )
...
class AIDecisionPipeline:
    ...
    def run(
        ...
        Args:
            ...
            task_id: Optional task ID for Cogscope tracing
        ...
        result.trace_id = reason_result.raw_llm_output  # Store for Cogscope
