"""Enforce command for Cogscope CLI - Runtime contract enforcement."""
...
def enforce_run(
    ...
    Example:
        cogscope enforce run "Solve 2x + 5 = 13" --contract math_contract.yaml
    """
...
def enforce_check(
    ...
    Example:
        cogscope enforce check trace_math_123 --contract math_contract.yaml
    """
    from cogscope.contracts import BehaviorContract, ContractValidator
...
def enforce_compare(
    ...
    Example:
        cogscope enforce compare --contract reasoning.yaml --prompt "Explain X" --models gpt-4o,gemini-2.5-flash
    """
    import time
